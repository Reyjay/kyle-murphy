...
define( 'PLUGINS', THEMEROOT . '/plugins' );
...
if ( ! function_exists( 'alpha_scripts' ) ) {
	function alpha_scripts() {
		...
		// Register scripts
		wp_register_script( 'jquery', SCRIPTS . '/jquery-2.0.0.min.js' );
		wp_register_script( 'bmodernizr', SCRIPTS . '/modernizr.js');
		wp_register_script( 'bootstrap-js', SCRIPTS . '/bootstrap.js');
		wp_register_script( 'photos', PLUGINS . '/prettyphoto/js/prettyphoto.js' );
		wp_register_script( 'owl-custom', PLUGINS . '/owl-carousel/js/owl.carousel.min.js' );
		wp_register_script( 'flex-slider', PLUGINS . '/flexslider/js/jquery.flexslider.js' );
		wp_register_script( 'sidr', PLUGINS . '/sidr/jquery.sidr.min.js' );
		wp_register_script( 'helper-plug', SCRIPTS . '/helper-plugins.js' );
		wp_register_script( 'way-point', SCRIPTS . '/waypoints.js' );
		wp_register_script( 'init', SCRIPTS . '/init.js' );
		wp_register_script( 'scripts', SCRIPTS . '/scripts.js' );
		...
		wp_enqueue_script( 'owl-custom' );
		wp_enqueue_script( 'sidr' );
		wp_enqueue_script( 'flex-slider' );
		wp_enqueue_script( 'helper-plug' );
		wp_enqueue_script( 'way-point' );
		...
		wp_enqueue_style( 'prettyPhoto', THEMEROOT . '/plugins/prettyphoto/css/prettyPhoto.css' );
		wp_enqueue_style( 'carousel', THEMEROOT . '/plugins/owl-carousel/css/owl.carousel.css' );
		wp_enqueue_style( 'owl-theme', THEMEROOT . '/plugins/owl-carousel/css/owl.theme.css' );
		wp_enqueue_style( 'color', THEMEROOT . '/css/color3.css' );
		wp_enqueue_style( 'sidr', THEMEROOT . '/plugins/sidr/jquery.sidr.dark.css' );
	}
